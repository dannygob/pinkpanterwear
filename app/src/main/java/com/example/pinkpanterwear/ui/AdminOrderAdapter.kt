...
import com.example.pinkpanterwear.R // Assuming R is in the base package
import com.google.firebase.Timestamp // For formatting date
import java.text.NumberFormat
import java.text.SimpleDateFormat
import java.util.Locale
import java.util.TimeZone // For date formatting consistency
...
class AdminOrderAdapter(
    ...
    class OrderViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val userNameTextView: TextView = itemView.findViewById(R.id.admin_order_user_name_text_view)
        private val totalTextView: TextView = itemView.findViewById(R.id.admin_order_total_text_view)
        private val statusTextView: TextView = itemView.findViewById(R.id.admin_order_status_text_view)
