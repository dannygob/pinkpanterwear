...
class ProductAdapter(
    ...
    class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val productNameTextView: TextView =
            itemView.findViewById(R.id.product_name_text_view)
        private val productPriceTextView: TextView =
            itemView.findViewById(R.id.product_price_text_view)
        ...
        fun bind(product: Product, onItemClicked: (Product) -> Unit) {
            ...
            format.currency = Currency.getInstance("USD") // Or use device locale currency
