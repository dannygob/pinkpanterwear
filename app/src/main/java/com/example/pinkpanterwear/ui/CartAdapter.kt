...
class CartAdapter(
    ...
    class CartViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val increaseQtyButton: Button = itemView.findViewById(R.id.cart_item_increase_qty_button)
        private val decreaseQtyButton: Button = itemView.findViewById(R.id.cart_item_decrease_qty_button)
        ...
        fun bind(
            ...
            itemPriceTextView.text = format.format(cartItem.product.price * cartItem.quantity) // Display total for this item line
