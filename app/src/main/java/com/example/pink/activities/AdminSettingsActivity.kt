...
class AdminSettingsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.admin_home_menu) {
            ...
            val intent = Intent(applicationContext, AdminOrdersActivity::class.java)
            startActivity(intent)
        } else if (item.itemId == R.id.admin_categories_menu) {
            val intent = Intent(applicationContext, adminCategoriesActivity::class.java)
            startActivity(intent)
        } else if (item.itemId == R.id.admin_products_menu) {
            val intent = Intent(applicationContext, AdminProductsActivity::class.java)
            startActivity(intent)
        } else if (item.itemId == R.id.admin_delivery_menu) {
            val intent = Intent(applicationContext, adminDeliveryActivity::class.java)
            startActivity(intent)
        } else if (item.itemId == R.id.admin_assistant_menu) {
            val intent = Intent(applicationContext, adminAssistantActivity::class.java)
            startActivity(intent)
