...
// import com.example.pinkpanterwear.domain.entities.Rating // Rating is nested in Product, direct import not needed if Product is imported.
    ...
    override suspend fun getCartItems(userId: String): List<CartItem> {
        ...
        return dboList.map { dbo ->
            ...
            val product = Product(
                ...
                description = "", // Not available in CartItemDbo, use default or fetch if critical
                category = "",    // Not available in CartItemDbo, use default or fetch if critical
                rating = null     // Not available in CartItemDbo, use default or fetch if critical
            )
            CartItem(
                product = product,
